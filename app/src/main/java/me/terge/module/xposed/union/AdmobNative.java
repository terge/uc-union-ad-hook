...
//        mConfig = Config.instance().getCurrentConfig(ADN.ADMOB, AdType.BANNER);
        ...
        config.adType(AdType.NATIVE.toString());
        config.isOn(true);
        config.adClz("com.google.android.gms.ads.c");
...
//        });
    ...
    public void hookLoad(XC_LoadPackage.LoadPackageParam loadPackageParam) throws ClassNotFoundException {
        ...
        Class adRequestClz = loadPackageParam.classLoader.loadClass("com.google.android.gms.ads.f");
